...
mathResources['t3_sets'] = [
    {
        ...
        description: `
            ...
            <h4>ðŸ“ How to Find Cardinality:</h4>
            <ol>
            ...
            <h4>âš ï¸ Important: Unique Items Only!</h4>
            ...
            <h4>âœ¨ Key Points to Remember:</h4>
            <ul>
    ...
    {
        title: 'Sets Introduction â€” Math is Fun',
        type: 'Article',
    ...
    {
        title: 'Match the Sets â€” Worksheet',
        type: 'Worksheet',
...
mathResources['t3_wordproblems'] = [
    {
        ...
        type: 'Introduction',
        description: `
            <h3>ðŸ“ The UPAC Problem Solving Method</h3>
            ...
            <h4>ðŸ“š How to use UPAC:</h4>
            <p><strong>1ï¸âƒ£ Understand:</strong> Read the problem carefully. What is the question asking? What information do you have?</p>
            <p><strong>2ï¸âƒ£ Plan:</strong> What operation will you use? Addition? Subtraction? Multiplication? Draw a picture or write a number sentence.</p>
            <p><strong>3ï¸âƒ£ Answer:</strong> Solve the problem. Show your work!</p>
            <p><strong>4ï¸âƒ£ Check:</strong> Does your answer make sense? Read the problem again and check your math.</p>
            
            <h4>âœ¨ Tips for Success:</h4>
            <ul>
    ...
    {
        title: 'Word Problems Tutorial â€” Video 1',
        type: 'Video',
    ...
    {
        title: 'Word Problems Strategy â€” Video 2',
        type: 'Video',
    ...
    {
        title: 'Adding Single-Digit Numbers â€” K5',
        type: 'Worksheet',
    ...
    {
        title: 'Times Tables by 5 â€” Video Song',
        type: 'Video',
    ...
    {
        title: 'Times Tables by 10 â€” Video Song',
        type: 'Video',
    ...
    },
    {
        ...
        type: 'Interactive',
        description: 'An interactive grid where students select cells to represent aÃ—b (random a and b between 1 and 10). Click and drag to select squares and see multiplication visually!',
    ...
    {
        title: 'Multiplication Word Problems A â€” K5',
        type: 'Worksheet',
    ...
    {
        title: 'Multiplication Word Problems B â€” K5',
        type: 'Worksheet',
    ...
    {
        title: 'Multiplication Word Problems C â€” K5',
        type: 'Worksheet',
    ...
    {
        title: 'Multiplication Word Problems D â€” K5',
        type: 'Worksheet',
    ...
    {
        title: 'Multiplication Word Problems 2Ã—1 Digit',
        type: 'Worksheet',
    ...
    {
        title: 'Math Drills â€” Times Tables Worksheets',
        type: 'Worksheet',
    ...
    {
        title: 'K5 Learning â€” Multiplication for Grade 2',
        type: 'Worksheet',
    ...
    {
        title: 'Math Playground â€” Multiplication Games',
        type: 'Game',
    ...
    {
        title: 'Multiplication Mine â€” ABCya',
        type: 'Game',
...
mathResources['t3_addsub_regroup'] = [
    {
        ...
        type: 'Introduction',
        description: 'ðŸ“– Learn what regrouping means and why we use it in addition and subtraction.',
        isVideo: false
    },
    {
        title: 'Addition with Regrouping â€” Video 1',
        type: 'Video',
    ...
    {
        title: 'Addition with Regrouping â€” Video 2',
        type: 'Video',
    ...
    {
        title: 'Subtraction with Regrouping â€” Video Tutorial',
        type: 'Video',
    ...
    {
        title: 'Addition & Subtraction 3-Digits â€” Worksheet A',
        type: 'Worksheet',
    ...
    {
        title: 'Addition & Subtraction 3-Digits â€” Worksheet B',
        type: 'Worksheet',
    ...
    {
        title: 'Addition & Subtraction 3-Digits â€” Worksheet C',
        type: 'Worksheet',
    ...
    {
        title: 'Addition & Subtraction 3-Digits â€” Worksheet D',
        type: 'Worksheet',
    ...
    {
        title: 'Addition & Subtraction 3-Digits â€” Worksheet E',
        type: 'Worksheet',
    ...
    {
        title: 'Addition & Subtraction 3-Digits â€” Worksheet F',
        type: 'Worksheet',
    ...
    {
        title: 'Regrouping Practice â€” Interactive Quiz',
        type: 'Game',
...
mathResources['t3_addsub_regroup'] = [
    ...
    { title: 'Wordwall â€” Three-digit addition & subtraction (game 1)', type: 'Game', description: 'Interactive practice: three-digit subtraction and addition with regrouping.', url: 'https://wordwall.net/resource/12252034/math/three-digit-subtraction-and-addition-with-regrouping', isVideo: false },
    { title: 'Wordwall â€” Three-digit regrouping (game 2)', type: 'Game', description: 'Interactive activities for regrouping practice.', url: 'https://wordwall.net/resource/10104496/math/3-digit-subtraction-and-addition-with-regrouping', isVideo: false },
    { title: 'Wordwall â€” Three-digit regrouping (game 3)', type: 'Game', description: 'Practice regrouping with fun activities.', url: 'https://wordwall.net/resource/9984200/three-digit-subtraction-and-addition-with-regrouping', isVideo: false },
    { title: 'Wordwall â€” Three-digit regrouping (game 4)', type: 'Game', description: 'More interactive regrouping practice.', url: 'https://wordwall.net/resource/8112100/math/three-digit-subtraction-and-addition-with-regrouping', isVideo: false }
];

// Added teacher-requested YouTube videos (Nov 2025)
mathResources['t3_addsub_regroup'].push(
    { title: 'Reagrupamiento - Video explicativo (1)', type: 'Video', description: 'Video sobre suma y resta con reagrupamiento â€” explicaciÃ³n paso a paso.', url: 'https://www.youtube.com/watch?v=cE-yrJv4TEs', isVideo: true },
    { title: 'Suma y Resta con Reagrupamiento - PrÃ¡ctica (2)', type: 'Video', description: 'Ejemplos y prÃ¡ctica guiada para reagrupamiento.', url: 'https://www.youtube.com/watch?v=1Al2Fc3wOIQ', isVideo: true },
    { title: 'Estrategias de Reagrupamiento - Tutorial (3)', type: 'Video', description: 'TÃ©cnicas visuales para sumar y restar con reagrupamiento.', url: 'https://www.youtube.com/watch?v=8_X680JiWDc', isVideo: true }
);
...
mathResources['t3_measurement'] = [
    {
        ...
        description: `
            <div style="max-width: 900px; margin: 0 auto;">
                <h3 style="text-align: center; color: #4A90E2; margin-bottom: 25px;">ðŸ“ Understanding Units of Measurement</h3>
                ...
                <h4 style="color: #5a67d8; border-bottom: 3px solid #5a67d8; padding-bottom: 10px; margin-top: 30px;">ðŸ“ Two Types of Measurement</h4>
                
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin: 25px 0;">
                    
                    <div style="background: #fff; border: 3px solid #48bb78; border-radius: 12px; padding: 20px; box-shadow: 0 3px 10px rgba(0,0,0,0.1);">
                        <div style="text-align: center; margin-bottom: 15px;">
                            <div style="font-size: 50px; margin: 10px 0;">âœ‹</div>
                ...
                <h4 style="color: #5a67d8; border-bottom: 3px solid #5a67d8; padding-bottom: 10px; margin-top: 35px;">ðŸ”¢ The Metric System</h4>
                
                <div style="background: linear-gradient(135deg, #ffeaa7 0%, #fdcb6e 100%); padding: 20px; border-radius: 12px; margin: 20px 0; border-left: 5px solid #f39c12;">
                    <p style="margin: 8px 0; font-size: 1.05em;"><strong>ðŸ“ 1 centimeter (cm)</strong> = <strong>10 millimeters (mm)</strong></p>
                    <p style="margin: 8px 0; font-size: 1.05em;"><strong>ðŸ“ 1 meter (m)</strong> = <strong>100 centimeters (cm)</strong></p>
                    <p style="margin: 8px 0; font-size: 1.05em;"><strong>ðŸ“ 1 kilometer (km)</strong> = <strong>1,000 meters (m)</strong></p>
                    <p style="margin: 12px 0 0 0; font-size: 0.95em; font-style: italic; color: #333;">
                        ðŸ’¡ The metric system is based on 10s â€” easy to convert!
                    </p>
                </div>
                
                <h4 style="color: #5a67d8; border-bottom: 3px solid #5a67d8; padding-bottom: 10px; margin-top: 35px;">ðŸ“ When to Use Each Unit</h4>
                ...
                <div style="background: linear-gradient(135deg, #a8e6cf 0%, #56ab2f 100%); color: white; padding: 20px; border-radius: 15px; margin-top: 30px; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                    <p style="font-size: 1.2em; margin: 0;">
                        <strong>ðŸŽ¯ Ready to measure?</strong> Watch the videos below and practice with worksheets!
                    </p>
                </div>
            </div>
        `,
    ...
    {
        title: 'Non-Standard Units of Measurement â€” Video',
        type: 'Video',
    ...
    {
        title: 'Standard Units of Length â€” Video 1',
        type: 'Video',
    ...
    {
        title: 'Standard Units of Length â€” Video 2',
        type: 'Video',
    ...
    {
        title: 'Standard Units of Length â€” Video 3',
        type: 'Video',
    ...
    {
        title: 'Standard Units of Length â€” Video 4',
        type: 'Video',
    ...
    {
        title: 'Standard Units of Length â€” Video 5',
        type: 'Video',
    ...
    {
        title: 'Convert Metric Units of Length â€” Video',
        type: 'Video',
    ...
    {
        title: 'Units of Length (Metric) â€” Worksheet A',
        type: 'Worksheet',
    ...
    {
        title: 'Units of Length (Metric) â€” Worksheet C',
        type: 'Worksheet',
    ...
    {
        title: 'Measuring Lengths to Nearest mm â€” Worksheet A',
        type: 'Worksheet',
    ...
    {
        title: 'Measuring Lengths to Nearest mm â€” Worksheet B',
        type: 'Worksheet',
    ...
    {
        title: 'Convert cm & mm â€” Worksheet A',
        type: 'Worksheet',
    ...
    {
        title: 'Convert cm & mm â€” Worksheet B',
        type: 'Worksheet',
    ...
    {
        title: 'Convert cm & mm â€” Worksheet C',
        type: 'Worksheet',
    ...
    {
        title: 'Convert cm & mm â€” Worksheet D',
        type: 'Worksheet',
    ...
    {
        title: 'Convert cm & mm â€” Worksheet E',
        type: 'Worksheet',
    ...
    {
        title: 'Convert cm & mm â€” Worksheet F',
        type: 'Worksheet',
    ...
    {
        title: 'Meters, cm & mm â€” Worksheet A',
        type: 'Worksheet',
    ...
    {
        title: 'Meters, cm & mm â€” Worksheet B',
        type: 'Worksheet',
    ...
    {
        title: 'Meters, cm & mm â€” Worksheet C',
        type: 'Worksheet',
    ...
    {
        title: 'Meters, cm & mm â€” Worksheet D',
        type: 'Worksheet',
    ...
    {
        title: 'Meters, cm & mm â€” Worksheet E',
        type: 'Worksheet',
    ...
    {
        title: 'Meters, cm & mm â€” Worksheet F',
        type: 'Worksheet',
...
mathResources['t3_timestables'] = [
    {
        title: 'Times Tables Practice â€” Interactive',
        type: 'Interactive Practice',
        description: 'Â¡Practica las tablas de multiplicar de forma interactiva y divertida! Elige quÃ© tabla practicar y mejora tu velocidad.',
